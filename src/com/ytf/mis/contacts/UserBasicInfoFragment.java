...
public class UserBasicInfoFragment extends Fragment{
    public static final String TAG  = "UserBasicInfoFragment";
     ...
     * @return
     */
    public static UserBasicInfoFragment newInstance(String title, UserBasicInfo info){
        if (fragment == null){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.txl_user_basic_fragment_main, container, false);
